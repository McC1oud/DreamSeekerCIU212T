...
public class TigerSkillsScript : MonoBehaviour {
    ...
    public void ActivateSkill1()
    {
        ...
        if (points >= 1 && skillcheck1 == false)
        {
            ...
            if (skillcheck1 == false)
            {
                ...
                GameObject.Find("Player").GetComponent<CharacterStats>().damage += 5;
            }
            skillcheck1 = true;
    ...
    public void ActivateSkill3()
    {
        ...
        if (points >= 5 && skillcheck2 == true && skillcheck3 == false)
        {
            ...
            //Text pound = GameObject.Find("TigerPound").GetComponent<Text>();
            //pound.text = "(Awakened) Tiger Pound";
            skilld.GetComponent<Text>().text = "Ability Skill\nEnergy Cost : 30\n\nPlayer leaps into the air, and drives \nhis fist into the ground, damaging enemies around him.";
            poundskill.GetComponent<Text>().text = "(Awakened) Tiger Pound";
            if (skillcheck3 == false)
            {
                // add skill here
                GameObject.Find("Player").GetComponent<PlayerController>().tigercost -= 10;
                GameObject.Find("PoundTriggerZone").GetComponent<PoundTrigger>().dmgmulti += 1;
